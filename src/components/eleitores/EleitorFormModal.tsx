    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 animate-in fade-in">
      <div className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[92vh] flex flex-col overflow-hidden border border-slate-200">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {/* Botões de Ação */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-4 border-t border-slate-200 sticky bottom-0 bg-white">
            
            {/* Navegação de Abas (Anterior / Próximo) */}
            <div className="flex items-center justify-between gap-3 w-full sm:w-auto">
              <button
                ...
                className="flex-1 sm:flex-none px-4 py-2 border border-slate-300 rounded-xl text-xs font-semibold text-slate-700 disabled:opacity-40 hover:bg-slate-50 transition-colors text-center"
              >
                ← Anterior
              </button>
              ...
              <button
                ...
                className="flex-1 sm:flex-none px-4 py-2 bg-slate-800 text-white rounded-xl text-xs font-semibold disabled:opacity-40 hover:bg-slate-700 transition-colors text-center"
              >
                Próxima Aba →
              </button>
            </div>

            {/* Ações do Cadastro (Cancelar / Concluir) */}
            <div className="flex items-center justify-between sm:justify-end gap-2.5 w-full sm:w-auto">
              <button
                type="button"
                onClick={onClose}
                className="flex-1 sm:flex-none px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold transition-colors text-center"
              >
                Cancelar
              </button>
              ...
              <button
                type="submit"
                className="flex-1 sm:flex-none px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-bold shadow-lg shadow-blue-600/30 transition-all flex items-center justify-center gap-1.5 cursor-pointer text-center"
              >
                <CheckCircle2 className="w-4 h-4 shrink-0" />
                <span className="truncate">{eleitorToEdit ? 'Salvar Alterações' : 'Concluir Cadastro'}</span>
              </button>
            </div>
